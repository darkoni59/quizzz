var quizz=[{question:"combiens de pattes à un chat?",value:"4 pas sur",rep1:"2,5 pattes",rep2:"sur un arbre?",rep3:"reponse B",rep4:"4 pas sur"},
    ...
    {question:"la lune et t'elle un satellite de la terre",value:"oui j'ai la TV graçe à elle",rep1:"bha nan ",rep2:"ses un caillou",rep3:"oui j'ai la TV graçe à elle",rep4:"une bonne planète mon pote"},
...
if (quizz[i].value===$('#rep'+s).html()){
    score++;
            ...
            $("#quizz").hide();
            $("#score").show();
            $("#score").html("nombre de bonnes reponses:"+score+'<br>');
            $('#score').append("vous avaits répondus:<br>"+scoreU);
        }
        if (i <= 9) {
            i++;
